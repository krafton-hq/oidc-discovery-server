...
import static com.krafton.sbx.plugins.pulsar.broker.authentication.oidc.ConfigUtils.getConfigValueAsBoolean;
...
public class AuthenticationProviderOpenID implements AuthenticationProvider {
    ...
    static void incrementFailureMetric(AuthenticationExceptionCode code) {
        AuthenticationMetrics.authenticateFailure(SIMPLE_NAME, AUTH_METHOD_NAME, code.toString());
    }
